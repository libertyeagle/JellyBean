...
class COCOImages(AbstractImagesDataset):
    ...
    def _raw(self):
        if self.data_split in ['train', 'val']:
            os.system('wget http://images.cocodataset.org/zips/{}.zip -P {}'.format(self.split_name, self.dir_raw))
        elif self.data_split == 'test':
            os.system('wget http://images.cocodataset.org/zips/test2015.zip -P '+self.dir_raw)
        else:
