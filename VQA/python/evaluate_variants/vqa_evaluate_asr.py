...
import vqa.datasets.vqa_transcription as vqa_transcription_dataset
...
def main():
    ...
    valset = vqa_transcription_dataset.factory('val', args.asr_model, options['vqa'], options['coco'])
    ...
    save_results(val_results, args.asr_model, valset.split_name(),
...
def save_results(results, asr_model_name, split_name, dir_logs, dir_vqa):
    dir_epoch = os.path.join(dir_logs, 'results_asr_{}'.format(asr_model_name))
