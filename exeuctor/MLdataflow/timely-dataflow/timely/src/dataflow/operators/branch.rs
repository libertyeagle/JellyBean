...
impl<S: Scope, D: Data> Branch<S, D> for Stream<S, D> {
    fn branch(
        ...
        // Note that we do not need to the provided initial capabilities
        // and we do not need to derive new capabilities from them.
        // we just acquire capabilities from input messages.
        // `_` is the initial capabilities here
        // it will just be dropped when the operator is built
        // we do not need it
